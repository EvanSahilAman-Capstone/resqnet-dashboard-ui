...
const ToggleRow: React.FC<RowProps> = ({
  label,
  checked,
  onChange,
  beta,
  ...
  <div
    className={`flex items-center justify-between px-3 py-2 rounded-lg transition-colors ${checked ? "bg-gray-100" : "hover:bg-gray-50"}`}
  >
